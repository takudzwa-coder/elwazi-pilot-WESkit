from flask import jsonify, request, Blueprint, redirect, abort, Response
...
def loginFct(requestedURL: str = "") -> Response:
    """
...
def refresh_access_token(response_object: Response = None) -> Response:
    """
...
def refresh_token_timeOK(token: str) -> bool:
    """
