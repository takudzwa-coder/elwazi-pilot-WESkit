...
from weskit.api.DrsUrlResolver import drsUrlResolver
...
def ListRuns(*args, **kwargs):
    ...
    try:
        ...
        runs = [{
            ...
            "state": RunStatus.from_stage(ProcessingStage.from_string(
                run_info["processing_stage"])).name
